...
#-----------------------------------
# python get_protein_seq_as_FASTA.py gene_id
#-----------------------------------
#
# Issue `get_protein_seq_as_FASTA.py  -h` for details.
# 
#
#
...
# get_protein_seq_as_FASTA("rpa12")
# -OR- 
...
def generate_output_file_name(gene_nom_info,extension_for_saving):
    ...
    '''
    return "S288C_{}_{}_protein.{}".format(
...
def main():
    ...
    get_protein_seq_as_FASTA(gene_id,**kwargs)
...
if __name__ == "__main__" and '__file__' in globals():
    ...
    parser = argparse.ArgumentParser(prog=
        'get_protein_seq_as_FASTA.py ',
        description="get_protein_seq_as_FASTA.py  \
        ...
        YeastMine, and saves the protein sequence in FASTA format.\
